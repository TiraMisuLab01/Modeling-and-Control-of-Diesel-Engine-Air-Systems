...
dominant_real_part = -0.4; % Satisfies |Re(lambda)| > sigma_min (0.4 > 0.2)
dominant_imag_part = 0.4;  % Chosen to satisfy the damping ratio requirement
...
% Dominant real part is -0.4, so choose -1.2 and -2.0 as non-dominant poles.
non_dominant_1 = -1.2;
non_dominant_2 = -2.0;
